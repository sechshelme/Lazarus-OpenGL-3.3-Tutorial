...
var
  ...
  NormalTexturBuffer:TTexturBuffer;
...
begin
  NormalTexturBuffer := TTexturBuffer.Create;
...
begin
  ...
  // Normal Textur laden
  NormalTexturBuffer.LoadTextures('normal.bmp');
...
begin
  ...
  NormalTexturBuffer.ActiveAndBind;
