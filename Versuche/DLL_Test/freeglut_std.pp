...
type Tproc=procedure;cdecl;
  Tproc1long=      procedure (para0:longint);
  Tproc2long=      procedure (para0,para1:longint);
  Tproc3long=      procedure (para0,para1,para2:longint);
  Tproc4long=      procedure (para0,para1,para2,para3:longint);
  Tproc5long=      procedure (para0,para1,para2,para3,para4:longint);

 Tproc1byte2long=        procedure (para1:byte; para2:longint; para3:longint);cdecl;
...
function glutCreateMenu(callback:Tproc1long):longint;cdecl;external glutLib;
...
procedure glutTimerFunc(time:dword; callback:Tproc1long; value:longint);cdecl;external glutLib;
//
...
procedure glutKeyboardFunc(callback:Tproc1byte2long);cdecl;external glutLib;
procedure glutSpecialFunc(callback:Tproc3long);cdecl;external glutLib;
procedure glutReshapeFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutVisibilityFunc(callback:Tproc1long);cdecl;external glutLib;

procedure glutDisplayFunc(callback:Tproc );cdecl;external glutLib;
procedure glutMouseFunc(callback:Tproc4long);cdecl;external glutLib;
procedure glutMotionFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutPassiveMotionFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutFunc(callback:Tproc1long);cdecl;external glutLib;
procedure glutKeyboardUpFunc(callback:Tproc1byte2long);cdecl;external glutLib;
procedure glutSpecialUpFunc(callback:Tproc3long);cdecl;external glutLib;
procedure glutJoystickFunc(callback:Tproc4long; pollInterval:longint);cdecl;external glutLib;
procedure glutMenuStateFunc(callback:Tproc1long);cdecl;external glutLib;
procedure glutMenuStatusFunc(callback:Tproc3long);cdecl;external glutLib;
procedure glutOverlayDisplayFunc(callback:Tproc );cdecl;external glutLib;
procedure glutWindowStatusFunc(callback:Tproc1long);cdecl;external glutLib;
procedure glutSpaceballMotionFunc(callback:Tproc3long);cdecl;external glutLib;
procedure glutSpaceballRotateFunc(callback:Tproc3long);cdecl;external glutLib;
procedure glutSpaceballButtonFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutButtonBoxFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutDialsFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutTabletMotionFunc(callback:Tproc2long);cdecl;external glutLib;
procedure glutTabletButtonFunc(callback:Tproc4long);cdecl;external glutLib;
{
