...
const
  ...
  TextureVertex: array[0..5] of TVector2f =    // Textur-Koordinaten
    ((0.0, 0.0), (64.0, 64.0), (0.0, 64.0),
    (0.0, 0.0), (64.0, 0.0), (64.0, 64.0));
...
begin
  ...
  with bit do begin
    ...
    glTexImage2D(GL_TEXTURE_RECTANGLE, 0, GL_RGB, Width, Height, 0, GL_BGR, GL_UNSIGNED_BYTE, RawImage.Data); // Zeiger auf Bitmap übergeben.
...
begin
  ...
  glBindTexture(GL_TEXTURE_RECTANGLE, textureID);  // Textur binden.
