{
    ...
    OpenGL ES loader generated by glad 0.1.36 on Tue May 21 13:06:20 2024.
    ...
    Commandline:
        --profile="core" --api="gles2=3.2" --generator="pascal" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=core&language=pascal&specification=gl&loader=on&api=gles2%3D3.2
}
unit oglglad_GLES32;
...
begin
  {$IFDEF Linux}
  LibGL := LoadLibrary('libGL.so.1');
  {$ENDIF}
  {$IFDEF Windows}
  LibGL := LoadLibrary('OpenGL32.dll');
  {$ENDIF}
  gladLoadGLES2(@LoadProc);
end;
