...
type
  ...
  public
    ...
    function UniformLocation(ch: PChar): GLint;
    function AttribLocation(ch: PChar): GLint;
...
begin
  ...
  if ErrorStatus = GL_FALSE then begin
    WriteLn('FEHLER in ' + '!', AShader + LineEnding + PChar(pc) + LineEnding);
  end;
...
function TShader.UniformLocation(ch: PChar): GLint;
begin
...
function TShader.AttribLocation(ch: PChar): GLint;
begin
