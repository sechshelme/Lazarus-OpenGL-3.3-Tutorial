...
procedure glColorTable(target: TGLenum; internalformat: TGLenum; Width: TGLsizei; format: TGLenum; _type: TGLenum; table: PGLvoid); cdecl; external;
procedure glColorSubTable(target: TGLenum; start: TGLsizei; Count: TGLsizei; format: TGLenum; _type: TGLenum; Data: PGLvoid); cdecl; external;
...
procedure glConvolutionFilter1D(target: TGLenum; internalformat: TGLenum; Width: TGLsizei; format: TGLenum; _type: TGLenum; image: PGLvoid); cdecl; external;
procedure glConvolutionFilter2D(target: TGLenum; internalformat: TGLenum; Width: TGLsizei; Height: TGLsizei; format: TGLenum; _type: TGLenum; image: PGLvoid); cdecl; external;
...
procedure glCopyConvolutionFilter2D(target: TGLenum; internalformat: TGLenum; x: TGLint; y: TGLint; Width: TGLsizei; Height: TGLsizei); cdecl; external;
...
procedure glSeparableFilter2D(target: TGLenum; internalformat: TGLenum; Width: TGLsizei; Height: TGLsizei; format: TGLenum; _type: TGLenum; row: PGLvoid; column: PGLvoid); cdecl; external;
procedure glGetSeparableFilter(target: TGLenum; format: TGLenum; _type: TGLenum; row: PGLvoid; column: PGLvoid; span: PGLvoid); cdecl; external;
{
 * OpenGL 1.3
  }
{ multitexture  }
