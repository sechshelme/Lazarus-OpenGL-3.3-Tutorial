...
function shaderc_compiler_initialize:Tshaderc_compiler_t;cdecl;external libshaderc;
...
procedure shaderc_compiler_release(para1:Tshaderc_compiler_t);cdecl;external libshaderc;
...
function shaderc_compile_options_initialize:Tshaderc_compile_options_t;cdecl;external libshaderc;
{ Returns a copy of the given shaderc_compile_options_t. }
{ If NULL is passed as the parameter the call is the same as }
{ shaderc_compile_options_init. }
function shaderc_compile_options_clone(options:Tshaderc_compile_options_t):Tshaderc_compile_options_t;cdecl;external libshaderc;
...
procedure shaderc_compile_options_release(options:Tshaderc_compile_options_t);cdecl;external libshaderc;
...
procedure shaderc_compile_options_add_macro_definition(options:Tshaderc_compile_options_t; name:Pchar; name_length:Tsize_t; value:Pchar; value_length:Tsize_t);cdecl;external libshaderc;
{ Sets the source language.  The default is GLSL. }
procedure shaderc_compile_options_set_source_language(options:Tshaderc_compile_options_t; lang:Tshaderc_source_language);cdecl;external libshaderc;
{ Sets the compiler mode to generate debug information in the output. }
procedure shaderc_compile_options_set_generate_debug_info(options:Tshaderc_compile_options_t);cdecl;external libshaderc;
{ Sets the compiler optimization level to the given level. Only the last one }
{ takes effect if multiple calls of this function exist. }
procedure shaderc_compile_options_set_optimization_level(options:Tshaderc_compile_options_t; level:Tshaderc_optimization_level);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_forced_version_profile(options:Tshaderc_compile_options_t; version:longint; profile:Tshaderc_profile);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_include_callbacks(options:Tshaderc_compile_options_t; resolver:Tshaderc_include_resolve_fn; result_releaser:Tshaderc_include_result_release_fn; user_data:pointer);cdecl;external libshaderc;
{ Sets the compiler mode to suppress warnings, overriding warnings-as-errors }
{ mode. When both suppress-warnings and warnings-as-errors modes are }
{ turned on, warning messages will be inhibited, and will not be emitted }
{ as error messages. }
procedure shaderc_compile_options_set_suppress_warnings(options:Tshaderc_compile_options_t);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_target_env(options:Tshaderc_compile_options_t; target:Tshaderc_target_env; version:Tuint32_t);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_target_spirv(options:Tshaderc_compile_options_t; version:Tshaderc_spirv_version);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_warnings_as_errors(options:Tshaderc_compile_options_t);cdecl;external libshaderc;
{ Sets a resource limit. }
procedure shaderc_compile_options_set_limit(options:Tshaderc_compile_options_t; limit:Tshaderc_limit; value:longint);cdecl;external libshaderc;
{ Sets whether the compiler should automatically assign bindings to uniforms }
{ that aren't already explicitly bound in the shader source. }
procedure shaderc_compile_options_set_auto_bind_uniforms(options:Tshaderc_compile_options_t; auto_bind:Tbool);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_auto_combined_image_sampler(options:Tshaderc_compile_options_t; upgrade:Tbool);cdecl;external libshaderc;
{ Sets whether the compiler should use HLSL IO mapping rules for bindings. }
{ Defaults to false. }
procedure shaderc_compile_options_set_hlsl_io_mapping(options:Tshaderc_compile_options_t; hlsl_iomap:Tbool);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_hlsl_offsets(options:Tshaderc_compile_options_t; hlsl_offsets:Tbool);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_binding_base(options:Tshaderc_compile_options_t; kind:Tshaderc_uniform_kind; base:Tuint32_t);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_binding_base_for_stage(options:Tshaderc_compile_options_t; shader_kind:Tshaderc_shader_kind; kind:Tshaderc_uniform_kind; base:Tuint32_t);cdecl;external libshaderc;
{ Sets whether the compiler should preserve all bindings, even when those }
{ bindings are not used. }
procedure shaderc_compile_options_set_preserve_bindings(options:Tshaderc_compile_options_t; preserve_bindings:Tbool);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_auto_map_locations(options:Tshaderc_compile_options_t; auto_map:Tbool);cdecl;external libshaderc;
{ Sets a descriptor set and binding for an HLSL register in the given stage. }
{ This method keeps a copy of the string data. }
procedure shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage(options:Tshaderc_compile_options_t; shader_kind:Tshaderc_shader_kind; reg:Pchar; set:Pchar; binding:Pchar);cdecl;external libshaderc;
{ Like shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage, }
{ but affects all shader stages. }
procedure shaderc_compile_options_set_hlsl_register_set_and_binding(options:Tshaderc_compile_options_t; reg:Pchar; set:Pchar; binding:Pchar);cdecl;external libshaderc;
{ Sets whether the compiler should enable extension }
{ SPV_GOOGLE_hlsl_functionality1. }
procedure shaderc_compile_options_set_hlsl_functionality1(options:Tshaderc_compile_options_t; enable:Tbool);cdecl;external libshaderc;
{ Sets whether 16-bit types are supported in HLSL or not. }
procedure shaderc_compile_options_set_hlsl_16bit_types(options:Tshaderc_compile_options_t; enable:Tbool);cdecl;external libshaderc;
{ Enables or disables relaxed Vulkan rules. }
{ }
{ This allows most OpenGL shaders to compile under Vulkan semantics. }
procedure shaderc_compile_options_set_vulkan_rules_relaxed(options:Tshaderc_compile_options_t; enable:Tbool);cdecl;external libshaderc;
{ Sets whether the compiler should invert position.Y output in vertex shader. }
procedure shaderc_compile_options_set_invert_y(options:Tshaderc_compile_options_t; enable:Tbool);cdecl;external libshaderc;
...
procedure shaderc_compile_options_set_nan_clamp(options:Tshaderc_compile_options_t; enable:Tbool);cdecl;external libshaderc;
...
function shaderc_compile_into_spv(compiler:Tshaderc_compiler_t; source_text:Pchar; source_text_size:Tsize_t; shader_kind:Tshaderc_shader_kind; input_file_name:Pchar; 
           entry_point_name:Pchar; additional_options:Tshaderc_compile_options_t):Tshaderc_compilation_result_t;cdecl;external libshaderc;
...
{ returned. }
function shaderc_assemble_into_spv(compiler:Tshaderc_compiler_t; source_assembly:Pchar; source_assembly_size:Tsize_t; additional_options:Tshaderc_compile_options_t):Tshaderc_compilation_result_t;cdecl;external libshaderc;
{ The following functions, operating on shaderc_compilation_result_t objects, }
{ offer only the basic thread-safety guarantee. }
{ Releases the resources held by the result object. It is invalid to use the }
{ result object for any further operations. }
procedure shaderc_result_release(result:Tshaderc_compilation_result_t);cdecl;external libshaderc;
{ Returns the number of bytes of the compilation output data in a result }
{ object. }
function shaderc_result_get_length(result:Tshaderc_compilation_result_t):Tsize_t;cdecl;external libshaderc;
{ Returns the number of warnings generated during the compilation. }
function shaderc_result_get_num_warnings(result:Tshaderc_compilation_result_t):Tsize_t;cdecl;external libshaderc;
{ Returns the number of errors generated during the compilation. }
function shaderc_result_get_num_errors(result:Tshaderc_compilation_result_t):Tsize_t;cdecl;external libshaderc;
{ Returns the compilation status, indicating whether the compilation succeeded, }
{ or failed due to some reasons, like invalid shader stage or compilation }
{ errors. }
function shaderc_result_get_compilation_status(para1:Tshaderc_compilation_result_t):Tshaderc_compilation_status;cdecl;external libshaderc;
...
function shaderc_result_get_bytes(result:Tshaderc_compilation_result_t):Pchar;cdecl;external libshaderc;
{ Returns a null-terminated string that contains any error messages generated }
{ during the compilation. }
function shaderc_result_get_error_message(result:Tshaderc_compilation_result_t):Pchar;cdecl;external libshaderc;
