...
extern shaderc_compile_options_t
...
extern shaderc_compile_options_t shaderc_compile_options_clone(
...
extern void shaderc_compile_options_release(
...
extern void shaderc_compile_options_add_macro_definition(
    shaderc_compile_options_t options, const char* name, size_t name_length,
    const char* value, size_t value_length);

// Sets the source language.  The default is GLSL.
extern void shaderc_compile_options_set_source_language(
    shaderc_compile_options_t options, shaderc_source_language lang);

// Sets the compiler mode to generate debug information in the output.
extern void shaderc_compile_options_set_generate_debug_info(
    shaderc_compile_options_t options);

// Sets the compiler optimization level to the given level. Only the last one
// takes effect if multiple calls of this function exist.
extern void shaderc_compile_options_set_optimization_level(
...
extern void shaderc_compile_options_set_forced_version_profile(
...
extern void shaderc_compile_options_set_include_callbacks(
...
// as error messages.
extern void shaderc_compile_options_set_suppress_warnings(
    shaderc_compile_options_t options);
...
extern void shaderc_compile_options_set_target_env(
    shaderc_compile_options_t options,
...
extern void shaderc_compile_options_set_target_spirv(
...
extern void shaderc_compile_options_set_warnings_as_errors(
    shaderc_compile_options_t options);

// Sets a resource limit.
extern void shaderc_compile_options_set_limit(
...
extern void shaderc_compile_options_set_auto_bind_uniforms(
...
extern void shaderc_compile_options_set_auto_combined_image_sampler(
    shaderc_compile_options_t options, bool upgrade);

// Sets whether the compiler should use HLSL IO mapping rules for bindings.
// Defaults to false.
extern void shaderc_compile_options_set_hlsl_io_mapping(
...
extern void shaderc_compile_options_set_hlsl_offsets(
...
extern void shaderc_compile_options_set_binding_base(
    shaderc_compile_options_t options,
...
extern void shaderc_compile_options_set_binding_base_for_stage(
    shaderc_compile_options_t options, shaderc_shader_kind shader_kind,
    shaderc_uniform_kind kind, uint32_t base);

// Sets whether the compiler should preserve all bindings, even when those
// bindings are not used.
extern void shaderc_compile_options_set_preserve_bindings(
...
extern void shaderc_compile_options_set_auto_map_locations(
    shaderc_compile_options_t options, bool auto_map);

// Sets a descriptor set and binding for an HLSL register in the given stage.
// This method keeps a copy of the string data.
extern void shaderc_compile_options_set_hlsl_register_set_and_binding_for_stage(
    shaderc_compile_options_t options, shaderc_shader_kind shader_kind,
...
extern void shaderc_compile_options_set_nan_clamp(
    shaderc_compile_options_t options, bool enable);
...
extern shaderc_compilation_result_t shaderc_compile_into_spv_assembly(
    const shaderc_compiler_t compiler, const char* source_text,
    size_t source_text_size, shaderc_shader_kind shader_kind,
    const char* input_file_name, const char* entry_point_name,
    const shaderc_compile_options_t additional_options);
...
extern shaderc_compilation_result_t shaderc_compile_into_preprocessed_text(
    const shaderc_compiler_t compiler, const char* source_text,
    size_t source_text_size, shaderc_shader_kind shader_kind,
    const char* input_file_name, const char* entry_point_name,
    const shaderc_compile_options_t additional_options);
...
// returned.
extern shaderc_compilation_result_t shaderc_assemble_into_spv(
...
extern void shaderc_result_release(shaderc_compilation_result_t result);

// Returns the number of bytes of the compilation output data in a result
// object.
extern size_t shaderc_result_get_length(const shaderc_compilation_result_t result);

// Returns the number of warnings generated during the compilation.
extern size_t shaderc_result_get_num_warnings(
    const shaderc_compilation_result_t result);

// Returns the number of errors generated during the compilation.
extern size_t shaderc_result_get_num_errors(const shaderc_compilation_result_t result);

// Returns the compilation status, indicating whether the compilation succeeded,
// or failed due to some reasons, like invalid shader stage or compilation
// errors.
extern shaderc_compilation_status shaderc_result_get_compilation_status(
...
extern const char* shaderc_result_get_bytes(const shaderc_compilation_result_t result);

// Returns a null-terminated string that contains any error messages generated
// during the compilation.
extern const char* shaderc_result_get_error_message(
    const shaderc_compilation_result_t result);

// Provides the version & revision of the SPIR-V which will be produced
extern void shaderc_get_spv_version(unsigned int* version, unsigned int* revision);
...
extern bool shaderc_parse_version_profile(const char* str, int* version,
