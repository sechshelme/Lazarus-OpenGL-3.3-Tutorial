...
{
  Automatically converted by H2Pas 1.0.0 from env.h
...
Type
Pshaderc_env_version  = ^shaderc_env_version;
Pshaderc_spirv_version  = ^shaderc_spirv_version;
Pshaderc_target_env  = ^shaderc_target_env;
{$IFDEF FPC}
{$PACKRECORDS C}
{$ENDIF}
