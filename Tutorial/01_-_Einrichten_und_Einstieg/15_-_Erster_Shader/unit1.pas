...
begin
  ...
  if ErrorStatus = 0 then begin
    ...
    SetLength(s, InfoLogLength);
    glGetShaderInfoLog(VertexShaderObject, InfoLogLength, @InfoLogLength, @s[1]);
  ...
  if ErrorStatus = 0 then begin
    ...
    SetLength(s, InfoLogLength);
    glGetShaderInfoLog(FragmentShaderObject, InfoLogLength, @InfoLogLength, @s[1]);
  ...
  if ErrorStatus = 0 then begin
    ...
    SetLength(s, InfoLogLength);
    glGetProgramInfoLog(ProgramObject, InfoLogLength, @InfoLogLength, @s[1]);
