...
rtl.module("program",["System","JS","Classes","SysUtils","browserconsole","Web"],function () {
  ...
  $mod.$main = function () {
    ...
    $mod.table1.appendChild($mod.row1);
    ...
    $mod.table1.appendChild($mod.row2);
    ...
    $mod.row2.appendChild($mod.row3_data_1);
    $mod.row2.appendChild($mod.row3_data_2);
    $mod.row2.appendChild($mod.row3_data_3);
    $mod.table1.appendChild($mod.row3);
