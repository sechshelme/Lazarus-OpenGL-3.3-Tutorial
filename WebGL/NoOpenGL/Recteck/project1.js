...
rtl.module("program",["System","Web","Classes","JS","SysUtils"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TForm",pas.System.TObject,function () {
    this.$init = function () {
      ...
      this.EHeight = null;
      this.EWidth = null;
      this.ELineWidth = null;
    };
    this.$final = function () {
      this.Canvas2D = undefined;
      this.Ex = undefined;
      this.Ey = undefined;
      this.EHeight = undefined;
      this.EWidth = undefined;
      this.ELineWidth = undefined;
    ...
    this.ButtonClick = function (Event) {
      ...
      var W = 0.0;
      var H = 0.0;
      pas.System.Writeln("Drawing rectangle");
      X = pas.SysUtils.StrToFloat(this.Ex.value);
      Y = pas.SysUtils.StrToFloat(this.Ey.value);
      W = pas.SysUtils.StrToFloat(this.EWidth.value);
      H = pas.SysUtils.StrToFloat(this.EHeight.value);
      this.Canvas2D.lineWidth = parseFloat(this.ELineWidth.value);
    ...
    this.Create$1 = function () {
      var $Self = this;
      function CreateNumberEdit(aName) {
        var Result = null;
        Result = document.createElement("input");
        Result.setAttribute("type","text");
        Result.value = "100";
        Result.name = aName;
        Result.setAttribute("style","width: 80px;");
        return Result;
      };
      var Panel = null;
      ...
      Button1.setAttribute("value","Draw rectangle");
      Button1.onclick = rtl.createSafeCallback($Self,"ButtonClick");
      this.EHeight = CreateNumberEdit("Height");
      this.EWidth = CreateNumberEdit("Width");
      this.ELineWidth = CreateNumberEdit("LineWidth");
      this.ELineWidth.setAttribute("type","text");
      this.ELineWidth.value = "0.5";
      this.Ex = CreateNumberEdit("X");
      this.Ey = CreateNumberEdit("Y");
      document.body.appendChild(Panel);
      Panel.appendChild(PanelContent);
      PanelContent.appendChild(Button1);
      PanelContent.appendChild(document.createTextNode("X"));
      PanelContent.appendChild(this.Ex);
      PanelContent.appendChild(document.createTextNode("Y"));
      PanelContent.appendChild(this.Ey);
      PanelContent.appendChild(document.createTextNode("Width"));
      PanelContent.appendChild(this.EWidth);
      PanelContent.appendChild(document.createTextNode("Height"));
      PanelContent.appendChild(this.EHeight);
      PanelContent.appendChild(document.createTextNode("LineWidth"));
      PanelContent.appendChild(this.ELineWidth);
      Panel.appendChild(PanelContent);
