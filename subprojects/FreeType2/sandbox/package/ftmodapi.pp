...
//    TFT_Module_Constructor = function (module:TFT_Module):TFT_Error;cdecl;
    TFT_Module_Constructor = function (module:Pointer):TFT_Error;cdecl;
{*************************************************************************
   *
   * @functype:
...
//    TFT_Module_Destructor = procedure (module:TFT_Module);cdecl;
    TFT_Module_Destructor = procedure (module:Pointer);cdecl;
{*************************************************************************
   *
   * @functype:
   *   FT_Module_Requester
...
TFT_Module_Requester = function (module:Pointer; name:Pchar):Pointer;cdecl;
{*************************************************************************
   *
   * @struct:
   *   FT_Module_Class
...
//function FT_Add_Module(library_:TFT_Library; clazz:PFT_Module_Class):TFT_Error;cdecl;external;
function FT_Add_Module(library_:Pointer; clazz:PFT_Module_Class):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @function:
   *   FT_Get_Module
...
(* Const before type ignored *)
//function FT_Get_Module(library_:TFT_Library; module_name:Pchar):TFT_Module;cdecl;external;
function FT_Get_Module(library_:Pointer; module_name:Pchar):Pointer;cdecl;external;
{*************************************************************************
   *
   * @function:
   *   FT_Remove_Module
...
//    function FT_Remove_Module(library_:TFT_Library; module:TFT_Module):TFT_Error;cdecl;external;
    function FT_Remove_Module(library_:Pointer; module:Pointer):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @macro:
   *   FT_FACE_DRIVER_NAME
...
(* Const before type ignored *)
(* Const before type ignored *)
//function FT_Property_Set(library_:TFT_Library; module_name:PFT_String; property_name:PFT_String; value:pointer):TFT_Error;cdecl;external;
function FT_Property_Set(library_:Pointer; module_name:PFT_String; property_name:PFT_String; value:pointer):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @function:
   *    FT_Property_Get
...
(* Const before type ignored *)
(* Const before type ignored *)
//function FT_Property_Get(library_:TFT_Library; module_name:PFT_String; property_name:PFT_String; value:pointer):TFT_Error;cdecl;external;
function FT_Property_Get(library_:Pointer; module_name:PFT_String; property_name:PFT_String; value:pointer):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @function:
...
//procedure FT_Set_Default_Properties(library_:TFT_Library);cdecl;external;
procedure FT_Set_Default_Properties(library_:Pointer);cdecl;external;
{*************************************************************************
   *
   * @function:
...
//    function FT_Reference_Library(library_:TFT_Library):TFT_Error;cdecl;external;
    function FT_Reference_Library(library_:Pointer):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @function:
   *   FT_New_Library
...
//    function FT_New_Library(memory:TFT_Memory; alibrary:PFT_Library):TFT_Error;cdecl;external;
    function FT_New_Library(memory:TFT_Memory; alibrary:Pointer):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @function:
   *   FT_Done_Library
...
//    function FT_Done_Library(library:TFT_Library):TFT_Error;cdecl;external;
    function FT_Done_Library(library_:Pointer):TFT_Error;cdecl;external;
{*************************************************************************
   *
   * @functype:
   *   FT_DebugHook_Func
...
procedure FT_Set_Debug_Hook(library_:Pointer; hook_index:TFT_UInt; debug_hook:TFT_DebugHook_Func);cdecl;external;
{*************************************************************************
   *
   * @function:
...
procedure FT_Add_Default_Modules(library_:Pointer);cdecl;external;
{*************************************************************************
   *
   * @section:
   *   truetype_engine
...
//    function FT_Get_TrueType_Engine_Type(library:TFT_Library):TFT_TrueTypeEngineType;cdecl;external;
    function FT_Get_TrueType_Engine_Type(library_:Pointer):TFT_TrueTypeEngineType;cdecl;external;
{  }
implementation
